...
class GreedyDynamicSelection(nn.Module):
    ...
    def fit(self,
        ...
        for temp in np.geomspace(start_temp, end_temp, temp_steps):
            ...
            for epoch in range(nepochs):
                ...
                for x, y in train_loader:
                    ...
                    for maxi in range(max_features):
                        if(counting%50==0 and maxi==10):
                          print(str(counting))
                          p = m.mean(dim=0)
                          print(str(p))
                          ...
                          sensors=[]
                          for i in range(0,10):
                            sensors = np.append(sensors, features[sorted_indices[0][i]])
        ...
        torch.save(selector.state_dict(), '/content/drive/MyDrive/selPre/selector')
        torch.save(predictor.state_dict(), '/content/drive/MyDrive/selPre/predictor')
